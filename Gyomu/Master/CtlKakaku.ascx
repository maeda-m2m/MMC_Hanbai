...
<asp:GridView ID="G" runat="server" AutoGenerateColumns="False" OnRowDataBound="G_RowDataBound" HeaderStyle-BackColor="#00008B" HeaderStyle-ForeColor="White">
    <Columns>
       ...
       <%-- <asp:TemplateField HeaderText="区分コード">
            <ItemTemplate>
               <asp:TextBox ID="TbxKubunCode" runat="server" Width="80"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="カテゴリー区分">
            <ItemTemplate>
                <asp:TextBox ID="TbxCateKubun" runat="server" Width="100"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>--%>
...
<%--        <asp:TemplateField HeaderText="利用状態">
            <ItemTemplate>
                <asp:CheckBox ID="CheckYuko" runat="server" />
            </ItemTemplate>
        </asp:TemplateField>--%>
    </Columns>
</asp:GridView>
