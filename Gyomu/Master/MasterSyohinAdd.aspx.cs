...
namespace Gyomu.Master
{
    public partial class MasterSyohinAdd : System.Web.UI.Page
    {
        ...
        private void SelectedShiiresaki()
        {
            for (int i = 0; i < D.Items.Count; i++)
            {
                Label LblShiireCode = D.Items[i].FindControl("LblShiireCode") as Label;
                RadComboBox RadMakerRyaku = D.Items[i].FindControl("RadMakerRyaku") as RadComboBox;
                DataMaster.M_Shiire_NewRow dr = ClassMaster.GetShiireCode2(RadMakerRyaku.Text, Global.GetConnection());
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            DataSet1.M_Kakaku_2DataTable dt = ClassMaster.SerchSyouhinCode(pc, Global.GetConnection());
            if (dt.Count >= 1)
            {
            ...
            DataSet1.M_Kakaku_2DataTable dd = ClassMaster.SerchSyouhinName(pn, Global.GetConnection());
            if (dd.Count >= 1)
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    DataMaster.V_ProductListDataTable dtN2 = ClassMaster.GetList(Global.GetConnection());
                    ClassMaster.CreateProductList(dtN2, Global.GetConnection());
