...
{
    public partial class SisetuSyosai : System.Web.UI.Page
    {
        private string VsID
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                lblMsg2.Text = "※マスタ新規画面に移動する場合このページは自動で閉じます。";
        ...
        private void Creste()
        {
            if (VsID != "")
            {
                ...
                if (dr != null)
                {
                    lblCode.Text = dr.FacilityNo.ToString();
                    lblSisetuName.Text = VsID;
                    lblTanto.Text = dr.FacilityResponsible;
        ...
        protected void BtnMaster_Click(object sender, EventArgs e)
        {
            ...
            string url2 = string.Format("/Mitumori/Syosai/SisetuSyosai.aspx");
