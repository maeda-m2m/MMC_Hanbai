<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthClosing.aspx.cs" Inherits="Gyomu.Closing.MonthClosing" %>
        ...
        <div>
            ...
            <table runat="server" id="table1">
                <tr>
                    ...
                    <td runat="server" class="tabletd">
                        <asp:Button runat="server" ID="BtnUpload" Text="アップロード" OnClick="BtnUpload_Click" CssClass="Btn" />
                    </td>
                </tr>
            </table>
            <table runat="server" id="table2">
                ...
                <tr>
                    ...
                    <td colspan="2" runat="server" class="tabletd">
