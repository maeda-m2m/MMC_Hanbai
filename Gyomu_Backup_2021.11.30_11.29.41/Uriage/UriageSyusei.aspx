<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UriageSyusei.aspx.cs" Inherits="Gyomu.Uriage.UriageSyusei" %>
<%@ Register Src="~/CtlMenu.ascx" TagName="Menu" TagPrefix="uc" %>
<%@ Register Src="~/Uriage/CtlUriageSyosai.ascx" TagName="Syosai" TagPrefix="uc2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <script type="text/javascript">
      ...
      function CntRow(cnt) {
        ...
        function CalcGoukeiTax(TbxJSuryouId, TbxJTankaId, TbxJGoukeiId, TbxSyouhiZeiId,TbxHSuryouId, TbxHTankaId, TbxHGoukeiId,lblArariID) {
...
<body>
	...
	<tbody>
		...
		<tr>
			...
			<td>
                <input type="text" id ="TbxTax" runat="server" class="classWidth" readonly="readonly"/></td>
...
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="ja-JP" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
		...
		<tr>
			...
			<td>
                <telerik:RadComboBox ID="RadZeikubun" runat="server" Width="65" Culture="ja-JP">
                    <Items>
                        <telerik:RadComboBoxItem runat="server" Text="税込" Value ="0" />
		...
		<tr>
			...
			<td class="Hedar">略名称</td>
			<td colspan="4">
                <telerik:RadComboBox ID="RadSisetMeisyo" runat="server" Width="350" Height="180px" AutoPostBack="true" EnableLoadOnDemand="True" OnItemsRequested="RadTyokusoMeisyo_ItemsRequested" OnSelectedIndexChanged="RadSisetMeisyo_SelectedIndexChanged" ></telerik:RadComboBox>
			</td>
