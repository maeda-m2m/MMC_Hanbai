<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reconciliation.aspx.cs" Inherits="Gyomu.Closing.Reconciliation" %>
        ...
        <div>
            <telerik:RadTabStrip ID="RT" runat="server" AutoPostBack="True" SelectedIndex="0" BackColor="#d2eaf6">
                <Tabs>
                    ...
                    <telerik:RadTab Text="消込" Font-Size="12pt" NavigateUrl="Reconciliation.aspx" Selected="true"></telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
        </div>
    </form>
