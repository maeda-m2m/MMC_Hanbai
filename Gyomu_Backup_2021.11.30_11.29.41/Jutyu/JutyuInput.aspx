<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JutyuInput.aspx.cs" Inherits="Gyomu.Jutyu.JutyuNyuryoku" %>
<%@ Register Src="~/CtlMenu.ascx" TagName="Menu" TagPrefix="uc" %>
<%@ Register Src="~/Jutyu/CtlJutyuSyosai.ascx" TagName="Syosai" TagPrefix="uc2" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div id="MainMenu" runat="server">
        ...
        <Tabs>
            <telerik:RadTab Text="受注情報" Font-Size="12pt" NavigateUrl="~/Jutyu/JutyuJoho.aspx">
            </telerik:RadTab>
            <telerik:RadTab Text="受注入力" Font-Size="12pt" NavigateUrl="~/Jutyu/JutyuInput.aspx" Selected="True">
            </telerik:RadTab>
        </Tabs>
            </telerik:RadTabStrip>
            <br />
            <asp:Button ID="BtnToroku" runat="server" Text="登録" Width="100px" style="height: 21px" OnClick="BtnToroku_Click" />
            <asp:Button ID="BtnUriage" runat="server" Text="売上" Width="100px" style="height: 21px" OnClick="BtnUriage_Click" />
            ...
            <asp:Label ID="lblMes" runat="server" Text=""></asp:Label>
             <div id="JutyuGamen" runat="server">
            <table>
            <tbody>
                <tr>
            <td>
	...
	<tbody>
		<tr>
			...
			<td>
                <telerik:RadComboBox ID="RadCate" runat="server" Width="120" OnSelectedIndexChanged="RadCate_SelectedIndexChanged" AutoPostBack="true"></telerik:RadComboBox>
			</td>
		...
		<tr>
			...
			<td colspan="6">
                <telerik:RadComboBox ID="RadTokuiMeisyo" runat="server" Width="200" Height="180px"  OnSelectedIndexChanged="RadTokuiMeisyo_SelectedIndexChanged" AutoPostBack="true" AllowCustomText="True" EnableLoadOnDemand="True" OnItemsRequested="RadTokuiMeisyo_ItemsRequested" ></telerik:RadComboBox>
			</td>
			...
			<td colspan="3"><telerik:RadDatePicker ID="RadDayMitumori" runat="server"></telerik:RadDatePicker></td>
		...
		<tr>
            ...
            <td>
                ...
                <telerik:RadComboBox ID="RadKikan" Runat="server" Width="60px" Culture="ja-JP" style="height: 22px" OnSelectedIndexChanged="RadKikan_SelectedIndexChanged" AutoPostBack="true">
                    <Items>
                        ...
                        <telerik:RadComboBoxItem runat="server" Text="80年" Value="allYear" />
                    </Items>
                </telerik:RadComboBox>
			...
			<td colspan="3"><telerik:RadDatePicker ID="RadDaySyoukai" runat="server"></telerik:RadDatePicker></td>
			<td class="Hedar">数量合計</td>
			<td>
                <asp:TextBox ID="lblSuryou" runat="server" CssClass="size"></asp:TextBox>
            </td>
			<td class="hoka">印刷フォーム</td>
			<td></td>
		</tr>
		<tr>
            ...
            <td>
                <asp:Label ID="Label1" runat="server" Text="複数" CssClass="size"></asp:Label>
			...
			<td colspan="3"><telerik:RadDatePicker ID="RadSiyouCalendar" runat="server" OnSelectedDateChanged="RadSiyouCalendar_SelectedDateChanged" AutoPostBack="true">
		...
		<tr>
			...
			<td colspan="3"><telerik:RadDatePicker ID="RadSyuryoCalendar" runat="server" DateInput-ReadOnly="true"></telerik:RadDatePicker></td>
		...
		<tr>
			...
			<td class="Hedar">略名称</td>
			<td colspan="4">
                <telerik:RadComboBox ID="RadSisetMeisyo" runat="server" Width="350" Height="180px" AllowCustomText="True" AutoPostBack="true" EnableLoadOnDemand="True" OnItemsRequested="RadTyokusoMeisyo_ItemsRequested" OnSelectedIndexChanged="RadSisetMeisyo_SelectedIndexChanged"></telerik:RadComboBox>
			</td>
			<td class="Hedar" id="Zasu" runat="server"><asp:Label ID="lblZasu" runat="server" Text="座数"></asp:Label>
			</td>
			...
			<td class="Hedar" id="Kaisu" runat="server"><asp:Label ID="lblKaisu" runat="server" Text="回数"></asp:Label>
                </td>
			...
			<td class="Hedar" id="Ryoukin" runat="server"><asp:Label ID="lblRyoukin" runat="server" Text="料金"></asp:Label></td>
			...
			<td class="Hedar" id="Basyo" runat="server"><asp:Label ID="lblBasyo" runat="server" Text="場所"></asp:Label></td>
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                         ...
                         <asp:Button ID="BtnDlt" runat="server" style="height: 21px" onclick="BtnDlt_Click"/>
                        <asp:Button ID="BtnCopy" runat="server" OnClick="BtnCopy_Click"  />
        <div class="right">
        <asp:Button ID="BtnInsert" runat="server" Text="行追加" Width="100px" style="height: 21px" OnClick="BtnInsert_Click" />
       </div>
            </td>
            </tr>
                </tbody>
        ...
        <asp:HiddenField ID="HidCsv_Suryo" runat="server" />
                <telerik:RadAjaxManager ID="R" runat="server">
