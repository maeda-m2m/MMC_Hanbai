...
namespace Gyomu.Master
{
    public partial class MasterOshirase : System.Web.UI.Page
    {
        ...
        private void ErrorSet(int v)
        {
            ...
            {
                case 1:
                    lbl_head.Text = "<font color=Red>" + "お知らせデータがありませんでした。" + "</font color>";
                    DGOshirase.DataSource = null;
                    DGOshirase.DataBind();
                    break;

                case 2:
                    lbl_head.Text = "<font color=Red>" + "お知らせ内容が入力されていません" + "</font color>";
                    break;

                case 3:
                    lbl_head.Text = "<font color=Red>" + "お知らせの登録ができませんでした。" + "</font color>";
                    break;

                case 4:
                    lbl_head.Text = "<font color=Red>" + "お知らせの削除に失敗しました。" + "</font color>";
                    break;
            }
        }
        ...
        private ClassKensaku.KensakuParam KensakuParam()
        {
            ...
            {
                p.CreateDate_Oshirase = RdpCreateDate.SelectedDate.Value.ToShortDateString().Replace("/", "-");
            }
            if (TbxNaiyou.Text != "")
            {
